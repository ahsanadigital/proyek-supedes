    ...
    <div class="row justify-content-center align-items-center min-vh-100">
        <div class="col-lg-4 col-sm-8 col-xs-12">
            <div class="card card-body">
                ...
                <form action="{{ route('ketua_rt.login-process') }}" method="post">
            ...
            <p class="m-0 mt-3 text-center">Masuk Sebagai<br/><a href="{{ route('lurah.login') }}">Kelurahan</a> | <a href="{{ route('ketua_rw.login') }}">Ketua RW</a></p>
        </div>
    </div>
</div>
@endsection
    ...
    submitHandler(e) {
        $.ajax({
            ...
            success(response) {
                ...
                setTimeout(() => {
                    window.location.href = '{{ route('ketua_rt.home') }}';
                }, 2500);
            },
            error(response) {
