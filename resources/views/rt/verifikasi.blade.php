    ...
    <div class="container-fluid my-4">
        <div class="row g-0 mt-4">
            <div class="col-md-8">
                ...
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item active">Verifikasi RT</li>
                </ol>
            </div>
        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="{{ route('ketua_rt.delete', $data->id) }}" class="btn btn-danger"><i class="fas fa-trash fa-fw me-2"></i>Hapus</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="lurah{{ md5($data->id_surat) }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="lurah{{ md5($data->id_surat) }}Label" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Batal</button>
                                    <a href="{{ route('ketua_rt.verify', $data->id) }}" class="btn btn-success"><i class="fas fa-check fa-fw me-2"></i>Selesaikan</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row text-white">
            <div class="col-md-4 bg-success py-3">
                <i class="fas fa-fw fa-check"></i> Verifikasi Kelurahan
            </div>
