                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            @if($item->for == 'ketua_rw' && $item->confirmed == 0)
                            <a href="{{ route('ketua_rw.krisar_verify', $item->id) }}" class="btn btn-success"><i class="fas fa-check fa-fw me-2"></i>Verifikasi</a>
                            @elseif ($item->for == 'ketua_rw' OR $item->for !== 'ketua_rw' && $item->confirmed == 1)
