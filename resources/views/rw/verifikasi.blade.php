        ...
        <div class="row g-0 mt-4">
            <div class="col-md-8">
                ...
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item active">Verifikasi RW</li>
                </ol>
            </div>
        </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="{{ route('ketua_rw.delete', $data->id) }}" class="btn btn-danger"><i class="fas fa-trash fa-fw me-2"></i>Hapus</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal fade" id="rw{{ md5($data->id_surat) }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="rw{{ md5($data->id_surat) }}Label" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Batal</button>
                                    <a href="{{ route('ketua_rw.verify', $data->id) }}" class="btn btn-success"><i class="fas fa-check fa-fw me-2"></i>Selesaikan</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <tr>
                        <td>
                            <div class="btn-group">
                                ...
                                <a href="{{ route('ketua_rw.cetak', $data->id) }}" class="btn {{ !$data->status ? 'disabled ' : '' }}btn-warning btn-sm"><i class="fas fa-download fa-fw"></i></a>
                                @endif
                            </div>
                        </td>
                        <td>{{ $data->id_surat }}</td>
