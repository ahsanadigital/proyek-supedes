...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="{{ route('ketua_rt.home') }}">{{ config('app.name') }}</a>
        <!-- Sidebar Toggle-->
            ...
            <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link{{ Request::is('rt') ? ' active' : '' }}" href="{{ route('ketua_rt.home') }}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link{{ Request::is('rt/verifikasi') ? ' active' : '' }}" href="{{ route('ketua_rt.verifikasi') }}">
                                <div class="sb-nav-link-icon"><i class="fas fa-check-circle fa-fw"></i></div>
                                Verifikasi Data
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link{{ Request::is('rt/kritik-saran') ? ' active' : '' }}" href="{{ route('ketua_rt.krisar_main') }}">
