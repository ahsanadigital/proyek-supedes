                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="nik">Nomor NIK/Kitas/Kitap</label>
                                                    <div class="input-group">
                                                        <span class="input-group-text">
                                                            <i class="fas fa-user fa-fw"></i>
                                                        </span>
                                                        <input type="text" class="form-control" name="nik" id="nik" placeholder="Nomor NIK/Kitas/Kitap Anda" />
                                                    </div>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="form-control" id="fullname">Nama Lengkap</div>
                                                    </div>
                                                    <div class="error-message"></div>
                                                </div>
...
$('#pengajuan #nik').on("keyup", function() {
    $.ajax({
        ...
        success(response) {
            $('#pengajuan #fullname').html(response.data.nama_lengkap);
        },
        error() {
